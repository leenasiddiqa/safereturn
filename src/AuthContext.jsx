...
export function AuthProvider({ children }) {
  ...
  useEffect(() => {
    ...
    console.log("🔄 Loading user from localStorage:", savedUser);
     console.log("🔄 Loading from sessionStorage:", savedAdmin);
   if (savedAdmin) {
    try {
      const adminData = JSON.parse(savedAdmin);
      setUser(adminData);
      console.log("✅ Admin loaded from sessionStorage:", adminData);
    } catch (error) {
  ...
  async function signup(sapid, username, password, name, phone) {
    try {
      console.log("📤 AUTH CONTEXT DATA:", { sapid, username, name, phone });
