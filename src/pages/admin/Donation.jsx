    ...
    try {
      ...
      if (donations.length === 0) {
        ...
        for (const item of foundItems) {
          ...
          const diffDays = (now - foundDate) / (1000 * 60 * 60 * 24); // ✅ DAYS mein calculate karo

          // ✅ 30 DAYS CONDITION - Sirf 30 days se zyada purane items
          if (!item.claimed && diffDays > 30 && item.category?.toLowerCase() !== "document") {
            donationsToCreate.push({
              ...
              userId: "admin-user", // ✅ Default userId add karo
            });
        ...
        // ✅ Agar donations already hain, directly set karo
